...
if (isset($_POST['login'])) { // if form has been submitted
	...
	while($info = mysql_fetch_array( $check )) 
	{
		...
		{ 
			...
			$query = mysql_query("SELECT fname,lname FROM `admin` WHERE username = '$username'");
...
<script language="javascript" type="text/javascript" src="../js/login_admin.js"></script>
...
<input name="login" type="submit" class="login_button" value="" style="padding-top:9px;"/>
