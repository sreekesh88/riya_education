...
function writeInputBox(type) {
	...
	if(type == 'username') {
		if(navigator.appName == "Netscape")
			...
			out = '<input name="username" type="text" class="login_textbox" style="padding-left:6px; color: grey; padding-top: 15px;" onFocus="check(this);" onBlur="check(this);" value="Username" tabindex="1"/>';
		else
	...
	if(type == 'password') {
		if(navigator.appName == "Netscape")
			...
			out = '<input name="password" type="text" class="login_textbox" style="padding-left:6px; padding-top: 13px; color: grey;" onFocus="check(this);" onBlur="check(this);" value="Password" tabindex="2"/>';
		else
