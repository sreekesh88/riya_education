...
if(isset($_POST['submit'])) {
	...
	$assign = mysql_query("UPDATE `students` SET `empCode` = '$newEmpCode', `branchID` = '$newBranch' WHERE studID = '$studID'");
	if($assign>0) {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	echo '<option value="'.$row['empCode'].'" class="padding_2">'.$row['fname']." ".$row['lname'].'</option>';
	}
    ?>
    </select>
    </td>
